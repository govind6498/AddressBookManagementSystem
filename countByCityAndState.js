...
editContact("Govind", "Kumar", "city", "NewDelhi");
console.log(addressBookArray);
...
console.log("\nSearch Avinasg In City - Devghar");
console.log("\nSearch Avinash In City - Devghar");
console.log(searchContactByCity("Avinash", "Devghar"));

console.log("\nSearch Killua In State - Delhi");
console.log(searchContactByState("Killua", "Delhi"));
