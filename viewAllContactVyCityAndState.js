...
console.log("\nSearch Avinash In City - KokuroMountain");
console.log(searchContactByCity("Avinash", "KokuroMountain"));

console.log("\nSearch Avinash In State - Delhi");
console.log(searchContactByState("Avinash", "Delhi"));


console.log("\nView Contacts By City : SchittsCreek \n" );
let cityBy = viewContactsByCity("SchittsCreek");
console.log(cityBy)

console.log("\nSearch Contact By State");
console.log(searchContactByState("Bihar")); 
console.log("\nView Contacts By State : Telgana \n" );
console.log(viewContactsByState("Telgana")); 